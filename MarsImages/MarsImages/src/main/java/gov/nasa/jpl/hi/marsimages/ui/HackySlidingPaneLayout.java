 ...
 */
public class HackySlidingPaneLayout extends ViewGroup {
    ...
    public HackySlidingPaneLayout(Context context) {
        this(context, null);
    }

    public HackySlidingPaneLayout(Context context, AttributeSet attrs) {
        this(context, attrs, 0);
    }

    public HackySlidingPaneLayout(Context context, AttributeSet attrs, int defStyle) {
...
//      return checkV && ViewCompat.canScrollHorizontally(v, -dx);
    ...
    interface SlidingPanelLayoutImpl {
        void invalidateChildRegion(HackySlidingPaneLayout parent, View child);
    }

    static class SlidingPanelLayoutImplBase implements SlidingPanelLayoutImpl {
        public void invalidateChildRegion(HackySlidingPaneLayout parent, View child) {
    ...
    private class DisableLayerRunnable implements Runnable {
        ...
        @Override
        public void run() {
            if (mChildView.getParent() == HackySlidingPaneLayout.this) {
