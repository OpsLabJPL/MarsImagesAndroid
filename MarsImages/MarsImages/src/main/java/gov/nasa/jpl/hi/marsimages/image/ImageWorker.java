package gov.nasa.jpl.hi.marsimages.image;
...
public abstract class ImageWorker {
     ...
     * image is found in the memory cache, it is set immediately, otherwise an {@link ImageAsyncTask}
     * will be created to asynchronously load the bitmap.
     *
     * @param data The URL of the image to download.
     * @param imageView The ImageView to bind the downloaded image to.
     */
    public void loadImage(Object data, ImageView imageView, PhotoViewAttacher attacher) {
        if (data == null) {
            return;
        }
     ...
     *            {@link ImageWorker#loadImage(Object, android.widget.ImageView, uk.co.senab.photoview.PhotoViewAttacher)}
     ...
     */
    private class BitmapWorkerTask extends ImageAsyncTask<Void, Void, BitmapDrawable> {
        private Object mData;
        private final WeakReference<ImageView> imageViewReference;
        private final WeakReference<PhotoViewAttacher> attacherReference;

        public BitmapWorkerTask(Object data, ImageView imageView, PhotoViewAttacher attacher) {
            mData = data;
            imageViewReference = new WeakReference<ImageView>(imageView);
            attacherReference = new WeakReference<PhotoViewAttacher>(attacher);
        }
        ...
        protected void onPostExecute(BitmapDrawable value) {
            ...
            if (value != null && imageView != null) {
                ...
                PhotoViewAttacher attacher = attacherReference.get();
                if (attacher != null)
                    attacher.update();
            }
